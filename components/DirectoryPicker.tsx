...
export function DirectoryPicker({ onCancel, onSelect, busy = false, error }: Props) {
  ...
  return createPortal(
    ...
    >
      <div className="directory-picker-panel" style={{ width: 520, maxWidth: "calc(100vw - 16px)", height: `min(620px, ${getAppViewportHeightCss(16)})`, maxHeight: getAppViewportHeightCss(16), display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 10, boxShadow: "0 8px 32px rgba(0,0,0,0.18)" }}>
